...
<%
    ...
    String absolutePath = getServletContext().getRealPath("/uploads/users/"+email+"/videos");
    ...
    rs1.updateString("post_content","./uploads/users/"+email+"/videos/"+filename);
    rs1.updateString("post_type","video");
    if(desc=="nodesc")
    {
